...
$.fn.barrage = function(opt) {
    ...
    var createView = function() {
        if(Obj.data.length > 1) {
            ...
            var ele = $('<div class="overflow-text" target="_blank" style="height:0;opacity:0;text-align:' + settings.direction.split(/\s+/)[1] + ';float:' + settings.direction.split(/\s+/)[1] + ';background-color:' + M.bgColors[randomIndex] + '"; href="javascript:;")">' + Obj.data[0].text + '</div>');
