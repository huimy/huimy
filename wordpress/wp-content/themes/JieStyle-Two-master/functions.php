...
<li id="comment-li-<?php comment_ID(); ?>" class="comment_li">
    <div id="comment-<?php comment_ID(); ?>">
        <div class="comment_top clearfix">
            ...
            <div class="pull-left">
                <p class="comment_author"><?php printf(__('%s'), get_comment_author_link()) ?>
               <?php  if($comment->user_id == 1){ printf(__('<span class="admin-logo"></span>')); } ?>
                </p>
...
global $post;
 ...
 ob_start();
  ob_end_clean();
   ...
   if(empty($output)){ $first_img = "https://i0.hdslb.com/bfs/archive/e62b6b095ef38dfb742687f11e4b570dde420b5d.png"; }else { $first_img = $matches [1][0]; } return $first_img;}
?>
...
<?php
function MY_oneword(){
    @$sql = mysqli_connect("192.168.2.101","root","suguohui2004","wordpress");
    if(mysqli_connect_errno()){
        echo "Mysql connect erron</br><p>please cheack again or ask admin for help</p>";
        return("wrong");
        exit;  
    }else {
