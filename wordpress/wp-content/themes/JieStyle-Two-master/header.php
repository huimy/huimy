...
<body>
<header id="header">
    <div><a href="<?php bloginfo('siteurl'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php echo stripslashes(get_option('tang_avatar')); ?>" alt="<?php bloginfo('name'); ?>" class="img-circle" width="50%"></a></div>
    <h1 id="name"><?php bloginfo('name'); ?></h1>
    <div class="sns">
        <!-- rss订阅原来地址  bloginfo('rss2_url');需要加上php标识符
            facebook                echo stripslashes(get_option('tang_facebook_url'));
        -->
        <?php if (get_option('tang_rss') == '显示') { ?><a href="https://blog.csdn.net/qq_39129185/rss/list" target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="top" title="RSS"><i class="fas fa-rss"></i></a><?php } ?>
        ...
        <?php if (get_option('tang_facebook') == '显示') { ?><a href="https://blog.csdn.net/qq_39129185?spm=1000.2115.3001.5343" target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="top" title="CSDN博客"><i class="fab fa-codiepie"></i></a><?php } ?>
    ...
    <div class="weixin">
        <b>微信咨询&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>
		<img src="<?php echo stripslashes(get_option('tang_weixin_img')); ?>" alt="微信" width="50%">
